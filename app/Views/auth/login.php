<div class="flex justify-center">
    <div class="w-full max-w-sm">
        ...
        <?php } ?>
        <form method="post" class="rounded-lg bg-white px-4 py-5 shadow-sm ring-1 ring-slate-100 space-y-4">
            ...
            <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-emerald-700 active:bg-emerald-800">Đăng nhập</button>
        </form>
    </div>
</div>
