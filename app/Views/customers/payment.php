...
<div class="rounded-lg border border-slate-200 bg-white px-4 py-4 ">
    <form method="post" action="<?php echo $basePath; ?>/customer/payment/store" class="space-y-4">
		...
		<div class="relative">
            ...
            <textarea name="note" rows="3" class="form-field block w-full rounded-xl border border-slate-300 bg-white px-3.5 text-sm outline-none transition focus:border-brand-500"></textarea>
        </div>
        <div class="flex items-center justify-end gap-3">
            <a href="<?php echo $basePath; ?>/customer/view?id=<?php echo $order['customer_id']; ?>" class="app-btn-secondary">
                Hủy
            </a>
