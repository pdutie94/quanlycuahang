...
<div class="mb-4 space-y-2">
	<div class="flex items-center justify-between gap-3">
		<div>
			<h1 class="text-lg font-medium tracking-tight">Công nợ nhà cung cấp</h1>
			<p class="mt-0.5 text-sm text-slate-500">Danh sách nhà cung cấp và số tiền còn nợ theo phiếu nhập.</p>
		</div>
	</div>
	<?php
	$activeReport = 'supplier-debt';
	...
	<form method="get" class="rounded-xl border border-slate-200 bg-white px-3 py-3 text-sm shadow-sm space-y-3">
		<input type="hidden" name="r" value="report/supplierDebt">
		...
		<div class="flex items-center justify-end gap-2">
			<a href="<?php echo $basePath; ?>/report/supplier-debt" class="inline-flex items-center rounded-full px-3 py-1 text-sm font-medium text-slate-500 hover:bg-slate-100">Đặt lại</a>
...
<div class="space-y-4">
	<div class="grid grid-cols-1 gap-3 md:grid-cols-3">
		...
		<div class="rounded-xl border border-purple-100 bg-purple-50 px-3 py-3 text-sm text-purple-900 shadow-sm">
			<div class="text-sm font-medium uppercase  text-purple-700">Còn nợ</div>
		...
		<div class="rounded-xl border border-slate-200 bg-white text-sm shadow-sm">
			<div class="flex items-center justify-between border-b border-slate-100 px-4 py-2">
				<div class="text-sm font-medium uppercase  text-slate-500">Danh sách công nợ nhà cung cấp</div>
			...
			<div class="overflow-x-auto">
				<table class="min-w-full divide-y divide-slate-100 text-sm">
					<thead class="bg-slate-50">
						<tr>
							<th class="px-3 py-2 text-left font-medium text-slate-600">Nhà cung cấp</th>
							<th class="px-3 py-2 text-left font-medium text-slate-600">Liên hệ</th>
							<th class="px-3 py-2 text-right font-medium text-slate-600">Tổng nhập</th>
							<th class="px-3 py-2 text-right font-medium text-slate-600">Đã thanh toán</th>
