...
<div class="mb-4 space-y-2">
	...
	<form method="get" class="rounded-xl border border-slate-200 bg-white px-3 py-3 text-sm space-y-4">
		...
		<div class="flex items-center justify-end gap-2">
			<a href="<?php echo $basePath; ?>/report/supplier-debt" class="inline-flex h-[34px] min-h-[34px] items-center justify-center rounded-lg px-4 text-sm font-medium text-slate-500 hover:bg-slate-100">Đặt lại</a>
