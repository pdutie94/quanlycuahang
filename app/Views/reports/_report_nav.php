...
<div class="mt-1 -mx-1">
	<div class="flex items-center gap-2 overflow-x-auto overflow-y-hidden whitespace-nowrap px-1 py-0.5">
		...
		<a href="<?php echo $basePath; ?>/report/sales" class="inline-flex shrink-0 items-center gap-1 rounded-full border pl-1 pr-2 py-1 text-sm font-medium shadow-sm <?php echo $isActive ? 'border-emerald-300 bg-emerald-50 text-emerald-700' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'; ?>">
		...
		<a href="<?php echo $basePath; ?>/report/inventory" class="inline-flex shrink-0 items-center gap-1 rounded-full border pl-1 pr-2 py-1 text-sm font-medium shadow-sm <?php echo $isActive ? 'border-sky-300 bg-sky-50 text-sky-700' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'; ?>">
		...
		<a href="<?php echo $basePath; ?>/report/customer-debt" class="inline-flex shrink-0 items-center gap-1 rounded-full border pl-1 pr-2 py-1 text-sm font-medium shadow-sm <?php echo $isActive ? 'border-rose-300 bg-rose-50 text-rose-700' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'; ?>">
		...
		<a href="<?php echo $basePath; ?>/report/supplier-debt" class="inline-flex shrink-0 items-center gap-1 rounded-full border pl-1 pr-2 py-1 text-sm font-medium shadow-sm <?php echo $isActive ? 'border-violet-300 bg-violet-50 text-violet-700' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'; ?>">
		...
		<a href="<?php echo $basePath; ?>/report/missing-cost" class="inline-flex shrink-0 items-center gap-1 rounded-full border pl-1 pr-2 py-1 text-sm font-medium shadow-sm <?php echo $isActive ? 'border-amber-300 bg-amber-50 text-amber-700' : 'border-slate-200 bg-white text-slate-700 hover:bg-slate-50'; ?>">
