...
<div class="app-modal-overlay" data-order-surcharge-modal>
    <div class="app-modal-sheet-sm">
        ...
        <div class="app-modal-body space-y-4">
            <div class="relative">
                <label class="app-label">Số tiền phụ thu</label>
                <div class="relative">
                    <input type="text" data-money-input="1" data-order-surcharge-modal-input class="form-field w-full rounded-xl border border-slate-300 bg-white px-3.5 pr-8 text-right text-sm font-medium text-slate-900 outline-none transition focus:border-brand-500" value="0">
