...
<div class="flex w-full rounded-full bg-slate-100 p-0.5 text-sm text-slate-700">
    <label class="inline-flex flex-1">
        ...
        <span class="inline-flex flex-1 items-center justify-center rounded-full px-3 py-2 font-medium text-slate-700 peer-checked:bg-emerald-600 peer-checked:text-white">Tiền mặt</span>
    </label>
    <label class="inline-flex flex-1">
        ...
        <span class="inline-flex flex-1 items-center justify-center rounded-full px-3 py-2 font-medium text-slate-700 peer-checked:bg-emerald-600 peer-checked:text-white">Chuyển khoản</span>
    </label>
</div>
