...
<?php if ($detailTitle !== '' || $detailBackUrl !== '') { ?>
	<div class="sticky top-0 z-20 border-b border-slate-200 bg-slate-50" data-list-sticky="1">
				...
				<?php if ($detailBackUrl !== '' || $detailActionsView !== '') { ?>
					<div class="flex flex-wrap items-center gap-1.5" data-header-actions-root>
						<?php if ($detailBackUrl !== '') { ?>
							<a href="<?php echo $basePath . '/' . ltrim($detailBackUrl, '/'); ?>" class="inline-flex min-h-10 items-center gap-2 rounded-xl border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50">
