            ...
            <?php if ($isPos) { ?>
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div class="space-y-2 md:col-span-2">
						...
						<div class="inline-flex w-full rounded-xl bg-slate-100 p-0.5 text-sm text-slate-700">
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-pos-customer-mode="existing">
                                Khách cũ
                            </button>
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-pos-customer-mode="new">
                                Khách mới
                            </button>
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-pos-customer-mode="guest">
                                Khách lẻ
                            </button>
                        </div>
                    </div>
            ...
            <?php } else { ?>
				...
				<div class="grid grid-cols-1 gap-4 md:grid-cols-2">
					...
					<div class="space-y-2 md:col-span-2">
						<label class="block text-sm text-slate-700">Khách hàng</label>
						<div class="inline-flex w-full rounded-xl bg-slate-100 p-0.5 text-sm text-slate-700">
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-order-customer-mode="existing">
								Khách cũ
							</button>
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-order-customer-mode="new">
								Khách mới
							</button>
							<button type="button" class="inline-flex flex-1 items-center justify-center rounded-xl px-3 py-2 font-medium text-slate-700" data-order-customer-mode="guest">
								Khách lẻ
							</button>
						</div>
					</div>
