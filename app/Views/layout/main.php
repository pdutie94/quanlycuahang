...
<div class="app-shell flex min-h-screen flex-col">
	<header class="app-topbar">
		<div class="app-content-wrap flex items-center justify-between gap-3 py-2.5 md:py-3">
			<div class="flex min-w-0 items-center gap-2">
				<a href="<?php echo $basePath; ?>/dashboard" class="flex min-w-0 items-center gap-2">
					<span class="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-700">
						<?php echo ui_icon('home', 'h-4 w-4'); ?>
					</span>
					<span class="block truncate font-display text-base font-semibold tracking-tight text-slate-900">Đại lý Đức Nam</span>
				</a>
			</div>
			<?php if ($user) { ?>
	...
	<main class="flex-1 pb-[4.3rem]">
		...
		<?php } ?>
		<div class="app-content-wrap <?php echo isset($detailHeader) ? 'pt-4 pb-6 lg:pt-6 lg:pb-10' : 'py-5 lg:py-9'; ?>">
	...
	<?php if ($user) { ?>
		...
		<div class="app-modal-overlay" data-app-menu-overlay>
			<div class="app-modal-sheet">
				<div class="flex items-center justify-between border-b border-slate-200/70 px-3 py-2">
				...
				<div class="flex-1 overflow-y-auto p-3 text-sm">
					<div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
						<a href="<?php echo $basePath; ?>/dashboard" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('home', 'h-5 w-5'); ?></span>
							<span>Tổng quan</span>
						</a>
						<a href="<?php echo $basePath; ?>/pos" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('cart', 'h-5 w-5'); ?></span>
							<span>Bán hàng</span>
						</a>
						<a href="<?php echo $basePath; ?>/order" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('clipboard-document', 'h-5 w-5'); ?></span>
							<span>Đơn hàng</span>
						</a>
						<a href="<?php echo $basePath; ?>/product" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('cube', 'h-5 w-5'); ?></span>
							<span>Sản phẩm</span>
						</a>
						<a href="<?php echo $basePath; ?>/purchase" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('purchase', 'h-5 w-5'); ?></span>
							<span>Phiếu nhập</span>
						</a>
						<a href="<?php echo $basePath; ?>/customer" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('user', 'h-5 w-5'); ?></span>
							<span>Khách hàng</span>
						</a>
						<a href="<?php echo $basePath; ?>/supplier" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('supplier', 'h-5 w-5'); ?></span>
							<span>Nhà cung cấp</span>
						</a>
						<a href="<?php echo $basePath; ?>/report/sales" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('chart-pie', 'h-5 w-5'); ?></span>
							<span>Báo cáo doanh thu</span>
						</a>
						<a href="<?php echo $basePath; ?>/report/inventory" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('chart-pie', 'h-5 w-5'); ?></span>
							<span>Báo cáo tồn kho</span>
						</a>
						<a href="<?php echo $basePath; ?>/category" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('categories', 'h-5 w-5'); ?></span>
							<span>Danh mục sản phẩm</span>
						</a>
						<a href="<?php echo $basePath; ?>/unit" class="flex items-center gap-3 rounded-lg border border-slate-200 bg-white p-2 hover:bg-slate-50">
							<span class="inline-flex h-8 w-8 items-center justify-center rounded-md bg-brand-50 text-brand-700"><?php echo ui_icon('unit', 'h-5 w-5'); ?></span>
