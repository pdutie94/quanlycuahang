...
<div class="app-shell flex min-h-screen flex-col">
	<main class="flex-1 pb-[5.25rem]">
		...
		<?php } ?>
		<div class="app-content-wrap <?php echo isset($detailHeader) ? 'pt-4 pb-6' : 'py-4 pb-6'; ?>">
			...
			<div class="app-modal-sheet">
				<div class="flex items-center justify-between border-b border-slate-200 px-4 py-3">
					...
					<button type="button" class="app-modal-close" data-app-menu-close>
						<?php echo ui_icon('x-mark', 'h-5 w-5'); ?>
					</button>
				</div>
				<div class="flex-1 overflow-y-auto p-4 text-sm">
					<div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
						<a href="<?php echo $basePath; ?>/dashboard" class="flex min-h-10 items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-3 hover:bg-slate-50">
							<span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand-50 text-brand-700"><?php echo ui_icon('home', 'h-5 w-5'); ?></span>
							<span>Tổng quan</span>
						</a>
						<a href="<?php echo $basePath; ?>/pos" class="flex min-h-10 items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-3 hover:bg-slate-50">
						...
						<a href="<?php echo $basePath; ?>/user/changePasswordForm" class="flex min-h-10 items-center gap-3 rounded-xl border border-slate-200 bg-white px-3 py-3 hover:bg-slate-50">
							<span class="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-brand-50 text-brand-700"><?php echo ui_icon('user', 'h-5 w-5'); ?></span>
							<span>Tài khoản</span>
						</a>
					</div>
