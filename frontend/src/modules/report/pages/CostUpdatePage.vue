...
const submitUpdate = async (item: CostUpdateItem) => {
    try {
        ...
        const payload = {
            product_id: item.id,
            price_cost: isNaN(parsed) ? "" : parsed,
        };
        ...
        <header>
            <div>
                ...
                <p class="text-slate-500 text-sm mt-1">
                    Cập nhật giá vốn cho sản phẩm. Tìm kiếm theo tên hoặc mã.
                </p>
            </div>
            <ReportNavButtons />
        </header>
                ...
                <table class="min-w-full table-auto bg-white">
                    <thead>
                        <tr class="text-sm text-slate-600 bg-slate-50">
                            <th class="p-2 text-left border-b border-slate-300">
                                Sản phẩm
                            </th>
                            <th
                                class="p-2 text-right border-b border-slate-300"
                            >
                                Giá vốn
                            </th>
                        </tr>
