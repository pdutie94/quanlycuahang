    ...
    <section v-else>
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <article class="rounded-2xl border border-sky-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-slate-900" :title="formatMoney(overview.orders_month?.total_amount)">{{ formatCompactMoney(overview.orders_month?.total_amount) }}</div>
        ...
        <article class="rounded-2xl border border-brand-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-slate-900" :title="formatMoney(overview.orders_month?.profit)">{{ formatCompactMoney(overview.orders_month?.profit) }}</div>
        ...
        <article class="rounded-2xl border border-brand-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-slate-900" :title="formatMoney(overview.orders_today?.total_amount)">{{ formatCompactMoney(overview.orders_today?.total_amount) }}</div>
        ...
        <article class="rounded-2xl border border-teal-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-slate-900" :title="formatMoney(overview.orders_today?.profit)">{{ formatCompactMoney(overview.orders_today?.profit) }}</div>
        ...
        <article class="rounded-2xl border border-amber-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-slate-900" :title="formatMoney(overview.purchases_month?.total_amount)">{{ formatCompactMoney(overview.purchases_month?.total_amount) }}</div>
        ...
        <article class="rounded-2xl border border-rose-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-rose-700" :title="formatMoney(overview.customer_debt)">{{ formatCompactMoney(overview.customer_debt) }}</div>
        ...
        <article class="rounded-2xl border border-violet-100 bg-white p-3">
          ...
          <div class="mt-0.5 text-lg font-semibold text-violet-700" :title="formatMoney(overview.supplier_debt)">{{ formatCompactMoney(overview.supplier_debt) }}</div>
