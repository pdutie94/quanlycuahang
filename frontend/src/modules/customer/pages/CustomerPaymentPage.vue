    ...
    <template v-else-if="order">
      ...
      <section class="app-card space-y-4">
        <div>
          ...
          <input v-model="amount" type="text" inputmode="numeric" class="h-10 w-full rounded-xl border border-slate-300 px-3 text-sm outline-none focus:border-brand-500" />
        </div>
        <div>
