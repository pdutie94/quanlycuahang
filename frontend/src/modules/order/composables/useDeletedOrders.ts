...
const defaultFilters = { q: '', status: '', order_status: '', from_date: '', to_date: '' };
...
export function useDeletedOrders() {
  ...
  return {
    items, meta, filters, load,
    loading: listRequest.loading, error: listRequest.error,
    restore: restoreRequest.execute, restoreLoading: restoreRequest.loading, restoreError: restoreRequest.error,
    purgeSelected: purgeRequest.execute, purgeLoading: purgeRequest.loading, purgeError: purgeRequest.error
  };
}
