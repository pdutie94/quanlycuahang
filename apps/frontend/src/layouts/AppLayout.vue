...
import { House, ShoppingCart, Boxes, ChartColumnBig, Menu, X } from 'lucide-vue-next'
...
const navItems = [
  ...
  { to: '/reports', label: 'Báo cáo', icon: ChartColumnBig },
]
        ...
        <div v-if="isMenuOpen" class="fixed inset-0 z-50 bg-black/35" @click.self="isMenuOpen = false">
          <div class="absolute bottom-0 left-0 right-0 rounded-t-3xl bg-white p-5 shadow-2xl">
            ...
            <div class="grid grid-cols-2 gap-2">
              ...
              <RouterLink to="/reports" class="rounded-xl border border-black/10 p-3" @click="isMenuOpen = false">Báo cáo</RouterLink>
