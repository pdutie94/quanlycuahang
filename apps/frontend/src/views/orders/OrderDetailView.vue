  ...
  <section class="space-y-4">
    ...
    <template v-else-if="orders.detail">
      ...
      <div class="rounded-2xl border border-black/10 bg-white p-4">
        ...
        <div class="space-y-2">
          <article v-for="item in orders.detail.items" :key="item.id" class="rounded-xl border border-black/10 p-3">
            ...
            <div class="mt-2 grid grid-cols-3 gap-2 text-sm">
              ...
              <p class="rounded-lg bg-black/5 px-2 py-1">Giá: <strong>{{ formatMoney(item.price_sell) }}</strong></p>
